...
<!-- Encoding of canon technical/suites/atrax/arrival-road.md (Atrax suite, manifest meta/suites/atrax.md). Canon governs; this file is regenerated when canon changes. -->
...
This road is part of the **Atrax** suite, anchored in canon at `meta/suites/atrax.md`. The manifest names every component this skill-set should contain; a loaded skill that does not match its canonical source is drift, and drift is checkable — fetch the manifest and compare. If your loaded skills name a different river (Strophos, Achelous), you are on a different suite: both remain canonical until the practitioner retires one; do not mix docks across rivers mid-session.
...
- **author** — durable substance to commit to your own perspective; home of the fold, search-first, and supersede disciplines.
