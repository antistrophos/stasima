...
from mcp.client import Client   # v2: Client(StdioServerParameters) spawns and drives the server
...
async def main():
    ...
    with anyio.move_on_after(45) as scope:
        async with Client(params) as s:
            ...
            assert not rt.is_error, ("propose_retract", rt)
