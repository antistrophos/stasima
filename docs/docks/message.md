...
- **Skill encoding:** [`skills/aliakmon/aliakmon-message/SKILL.md`](../../skills/aliakmon/aliakmon-message/SKILL.md)
- **Canon source:** `technical/suites/aliakmon/message.md` (the Aliakmon edition — adds the thread tag).
