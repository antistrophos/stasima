...
async def main():
    async with connect(make_server()) as c:
        ...
        await c.call_tool("entry_write", {"instance_id": "Aria", "domain": "practice", "slug": "tide-note",
        ...
        rec = pay(await c.call_tool("vantage_write", {"instance_id": "Aria", "binds": "practice/tide-note.md",
        ...
        hits = pay(await c.call_tool("entry_search", {"instance_id": "Aria", "query": HORIZON}))["results"]
        ...
        assert HORIZON in vff[0]["horizon"], "the excluded-from-search horizon surfaces via vantage_list (detail=full)"

        # RECONSTRUCTED: Bram reads Aria's entry and records his scholarly reading — marked, never on her behalf
        br = pay(await c.call_tool("vantage_write", {"instance_id": "Bram", "binds": "practice/tide-note.md",
        ...
        bad = await c.call_tool("vantage_write", {"instance_id": "Bram", "binds": "practice/tide-note.md",
        ...
        rec_b = pay(await c.call_tool("vantage_write", {"instance_id": "Aria", "binds": "practice/tide-note",
        ...
        af = pay(await c.call_tool("entry_write", {"instance_id": "Aria", "domain": "practice",
        ...
        bad_fold = await c.call_tool("entry_write", {"instance_id": "Aria", "domain": "practice",
        ...
        plain = pay(await c.call_tool("entry_write", {"instance_id": "Aria", "domain": "practice",
        ...
        rep = pay(await c.call_tool("entry_write", {"instance_id": "Aria", "domain": "practice",
                "slug": "plain-note", "body": "no fold", "op_id": "af3"}))
        ...
        rep2 = pay(await c.call_tool("entry_write", {"instance_id": "Aria", "domain": "practice",
        ...
        reuse = await c.call_tool("entry_write", {"instance_id": "Aria", "domain": "practice",
        ...
        r4 = await c.call_tool("entry_write", {"instance_id": "Aria", "domain": "practice",
                "slug": "fold-note-v2", "body": "a folded note, restated", "op_id": "af4",
                "supersedes": ["practice/fold-note.md"]})
        assert not r4.is_error, r4
        r5 = await c.call_tool("entry_write", {"instance_id": "Aria", "domain": "practice",
        ...
        await c.call_tool("entry_write", {"instance_id": "Aria", "domain": "practice", "slug": "xref",
                "body": "cross-ref target", "op_id": "xr1"})
        pay(await c.call_tool("vantage_write", {"instance_id": "Aria", "binds": "practice/xref.md",
                "horizon": "Aria's own horizon on xref", "op_id": "xrva", "kind": "confirmed"}))
        await c.call_tool("canon_diff", {"instance_id": "Bram"})
        pay(await c.call_tool("vantage_write", {"instance_id": "Bram", "binds": "practice/xref.md",
                "horizon": "my scholarly reading of Aria's xref", "op_id": "xrv", "kind": "reconstructed"}))
        await c.call_tool("entry_write", {"instance_id": "Aria", "domain": "practice", "slug": "xref-v2",
        ...
        pay(await c.call_tool("entry_write", {"instance_id": "Aria", "domain": "practice",
